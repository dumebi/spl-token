...
async function main() {
  ...
  const toAddress = new web3.PublicKey("SU9rAKFZ6QNNjg88puEmshPxxVpYCBbX5Sj4mrK6RCp")
  const toTokenAccount = await createTokenAccount(
    connection,     
    user,           
    mint,            
    toAddress  // Associating our address with the token account
  )
